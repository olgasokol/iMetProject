...
# Hyper-parameters
# --------------------------------
train_data = IMetDataset(root_dir='./train_', labels_csv='./labels.csv', 
                         annotations_csv='./train.csv', transform=train_data_transforms)
...
val_data = IMetDataset(root_dir='./train_', labels_csv='./labels.csv', annotations_csv='./train.csv',
